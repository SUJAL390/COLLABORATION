          ...
          {error ? (
            ...
            <form className="space-y-6" onSubmit={onHandleSubmit}>
              ...
              <div>
                ...
                <div className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-pink-500 focus:border-pink-500 sm:text-sm">
                  <DatePicker
                    selected={startDate}
