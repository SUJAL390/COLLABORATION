              ...
              <div className="relative bg-gray-50">
                ...
                <div className="px-6 pb-6 mt-8">
                  <a className="block px-6 mb-2" href="#">
                    ...
                    <p className="text-lg font-bold font-heading text-pink-500">
                  ...
                  <a
                    className="ml-auto mr-2 flex items-center justify-center w-12 h-12 bg-pink-300 hover:bg-pink-400 rounded-md"
                    href="#">
                    <svg
                      width={12}
                      height={12}
