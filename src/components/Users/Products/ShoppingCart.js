          ...
          >
              ...
              <form onSubmit={applyCouponSubmit}>
                <div className="mt-1">
                  <input
                    ...
                    type="text"
                    className="block w-full rounded-md border p-2 border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 sm:text-sm"
                ...
                {loading ? (
                  ...
                  <button className="inline-flex  text-center mt-4 items-center rounded border border-transparent bg-green-600 px-2.5 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2">
                    Apply coupon
                  </button>
                )}
              </form>
            ...
            <div className="mt-6">
              <Link
                ...
                className="w-full rounded-md border border-transparent bg-pink-600 py-3 px-4 text-base font-medium text-white shadow-sm hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2 focus:ring-offset-gray-50"
              >
                Proceed to Checkout
              </Link>
            </div>
