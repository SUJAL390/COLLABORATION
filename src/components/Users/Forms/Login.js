                ...
                >
                  <div className="w-full md:w-1/2 px-4 mb-8 md:mb-12">
                    <label>
                      ...
                      <input
                        ...
                        className="p-5 w-full border border-gray-200 focus:ring-pink-300 focus:border-pink-300 rounded-md "
                        type="email"
                      />
                    </label>
                  </div>
                  ...
                  <div className="w-full px-4">
                    {loading ? (
                      ...
                      <button className="bg-pink-800 hover:bg-pink-900 text-white font-bold font-heading py-5 px-8 rounded-md uppercase">
                        Login
                      </button>
                    )}
                  </div>
