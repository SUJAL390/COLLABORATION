...
export default function Navbar() {
  ...
  const categoriesToDisplay = categories?.categories?.slice(1,6)
    ...
    <div className="bg-pink-200 ">
      ...
      <header className="relative z-10">
        <nav aria-label="Top">
          ...
          {/* Deskto Navigation */}
          <div className="bg-pink-200 sticky">
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  ...
                  {user?.userFound?.isAdmin && (
                      <Link
                        to="/admin"
                        className="inline-flex items-center rounded-md border border-transparent bg-white px-4 py-2 text-sm font-medium text-black shadow-sm focus:outline-none focus:ring-2 focus:ring-pink-500 focus:ring-offset-2"
                      >
                        Admin Dashboard
                      </Link>
                    )}
